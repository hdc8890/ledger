...
| 2 | Dashboard MVP | 🔄 In progress | Task 1 (app shell + nav) ✅ · Task 2 (schema + query layer) ✅ · Task 3 (net worth dashboard) ✅ · Task 4 (cash flow dashboard) ✅ · Task 5 (asset dashboard) ✅ |
